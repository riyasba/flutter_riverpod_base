...
GetGitRepoModel getGitRepoModelFromJson(String str) => GetGitRepoModel.fromJson(json.decode(str));

String getGitRepoModelToJson(GetGitRepoModel data) => json.encode(data.toJson());
...
class GetGitRepoModel {
    ...
    factory GetGitRepoModel.fromJson(Map<String, dynamic> json) => GetGitRepoModel(
